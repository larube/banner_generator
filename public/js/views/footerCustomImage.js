define(['hbs!templates/generator_custom_image_footers/customImageFooter', 'hbs!templates/generator_custom_image_footers/showLinkTemplate', 'select2', 'uniform', 'utf8', 'jqueryForm', 'ThreeAIncView'], function(customImageFooterTemplate, showLinkTemplate, select2, uniform, utf8, jqueryForm, ThreeAIncView){
	var FooterCustomImageView =Backbone.View.extend({
		el  		: $('#content'),
		...
		render : function(){
			...
			$.ajax({
				...
				dataType: 'json'
					...
					self.$el.html(customImageFooterTemplate(templateConfig));
