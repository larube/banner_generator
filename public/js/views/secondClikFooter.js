define(['hbs!templates/generator_second_click_banners/getImageBanner', 'select2', 'uniform', 'utf8', 'jqueryForm', 'ThreeAIncView'], function(customImageBannerTemplate, select2, uniform, utf8, jqueryForm, ThreeAIncView){
	var SecondClickBannerView =Backbone.View.extend({
		el  		: $('#content'),
