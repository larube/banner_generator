define(['hbs!templates/generator_custom_image_overslides/customImageOverslide', 'hbs!templates/generator_custom_image_overslides/showLinkTemplate', 'select2', 'uniform', 'utf8', 'jqueryForm', 'ThreeAIncView'], function(customImageOverslideTemplate, showLinkTemplate, select2, uniform, utf8, jqueryForm, ThreeAIncView){
	var OverslideCustomImageView =Backbone.View.extend({
		el  		: $('#content'),
		...
		render : function(){
			...
			$.ajax({
				...
				dataType: 'json'
					...
					self.$el.html(customImageOverslideTemplate(templateConfig));
	...
	return OverslideCustomImageView;
});
